...
\begin{supertabular}{p{17.3cm}}
	...
	\item \footnotesize Results-oriented MBA candidate and business professional with over 5 years of experience spanning project management and business analytics. Proven track record in business analytics, with an MBA focus on \emph{general management} and competencies in project management, marketing, and team leadership.
	\end{enumerate*} \\														
\end{supertabular}
...
\begin{supertabular}{p{1.5cm}p{13.9cm}>{\raggedleft\arraybackslash}p{1.5cm}}
	...
	\item \small Statistics, GPA: 3.95; Cummulative GPA 3.91
	\end{enumerate*} 														
	& \\
...
\begin{supertabular}{p{8.65cm} p{8.65cm}}
	...
	\begin{enumerate*}[label =$\circ$, itemjoin={\newline}]
		\item \footnotesize Sloan Merit Scholarship
		\item \footnotesize New Venture Challenge - Runner-up
		\item \footnotesize Business Analytics Hackathon Facilitator
																\end{enumerate*}


	& \begin{enumerate*}[label =$\circ$, itemjoin={\newline}]
                                \item \footnotesize Directed fundraisers and organized campus activities as TREATMENT. 
                                \item \footnotesize American Management Association
