...
\begin{supertabular}{p{17.3cm}}
	...
	\item \small Results-oriented MBA candidate and business professional with over 5 years of experience spanning project management and business analytics. Proven track record in business analytics, with an MBA focus on \emph{general management} and competencies in project management, marketing, and team leadership.
	\end{enumerate*} \\
\end{supertabular}
...
\begin{supertabular}{p{13.9cm}>{\raggedleft\arraybackslash}p{3.4cm}}
	...
	\begin{enumerate*}[label =$\circ$, itemjoin={\newline}]
		\item \footnotesize Managed a project's lifecycle, directing engineering, design, and business teams to guide a project from strategic planning to development.
