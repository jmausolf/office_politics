...
\begin{supertabular}{p{1.5cm}p{13.9cm}>{\raggedleft\arraybackslash}p{1.5cm}}
	...
	\item \footnotesize \textsc{Management} MBA with experience in project management, team leadership, product marketing, and business analytics.
...
\begin{supertabular}{p{13.9cm}>{\raggedleft\arraybackslash}p{3.4cm}}
	...
	\begin{enumerate*}[label =$\circ$, itemjoin={\newline}]
		...
		\item \footnotesize Demonstrated capacity to apply market and competitive analysis research to business plann development.
	\end{enumerate*} & \\
	\multicolumn{2}{c}{} \\
...
\begin{supertabular}{p{13.9cm}>{\raggedleft\arraybackslash}p{3.4cm}}
	...
	& \textsc{2017-2019} \\
	\begin{enumerate*}[label =$\circ$, itemjoin={\newline}]
		\item \footnotesize Sloan Merit Scholarship, New Venture Challenge - Runner-up, Business Analytics Hackathon Facilitator
