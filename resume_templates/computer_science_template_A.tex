...
\begin{supertabular}{p{2cm} p{1.0cm} p{13.9cm}}
	\textsc{2019}		&		\textsc{M.S.} & \textsc{GRADSCHOOL}, \small GADEPARTMENT \\
					&&		 \begin{enumerate*}[label =$\diamond$, itemjoin={\newline}] 
							 ...
							 \end{enumerate*}  \\
	\textsc{2017} 	& 	\textsc{B.S.} & \textsc{UGSCHOOL}, \small Computer Science, \emph{summa cum laude}, GPA 3.90 \\
	\multicolumn{2}{c}{} \\
\end{supertabular}
...
\begin{supertabular}{p{3.4cm} p{13.9cm}}
	...
	\textsc{Computing}			& \begin{enumerate*}[label =$\diamond$, itemjoin={\newline}]
																\item \small \textsc{Python, C++, Java, Scala, R, Spark, Hadoop, SQL}
...
\begin{supertabular}{l p{0.55cm} p{13.9cm}}
	...
	\textsc{2016-2017}		&& \textsc{UGSCHOOL}, UG_CITYSTATE \\
	\textsc{}							&& \small	\emph{Research Assistant}, Department of Computer Science \\
												&& \begin{enumerate*}[label =$\diamond$, itemjoin={\newline}]
