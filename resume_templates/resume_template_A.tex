...
\begin{supertabular}{p{2cm} p{1.0cm} p{13.9cm}}
	...
	\textsc{2013} 	& 	\textsc{B.S.} & \textsc{UGSCHOOL}, \small Mathematics, \emph{summa cum laude}, GPA 3.90 \\
	\multicolumn{2}{c}{} \\
\end{supertabular}
...
\begin{supertabular}{p{3.4cm} p{13.9cm}}
	...
	\textsc{Interests:} 		& \small Squash, Cycling, Travel, Backpacking, Winter Sports \\
