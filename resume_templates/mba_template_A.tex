...
\begin{supertabular}{p{3.4cm} p{13.9cm}}
	...
	\textsc{Office:}					& \small\textsc{Microsoft}: \footnotesize Word, PowerPoint, Access, Outlook, Excel;	\small\textsc{Project management:} \footnotesize Salseforce CRM, Trello, Basecamp; \vspace{1mm} \\
