...
\begin{supertabular}{l p{0.55cm} p{13.9cm}}
	...
	\small\textsc{}							&& \small	\emph{Graduate Research Assistant}, \small Department of GADEPARTMENT \\
															&& \begin{enumerate*}[label =$\diamond$,itemjoin={\newline}]
																	\item \footnotesize Developed an enhanced Bayesian algorithm with $\mathbf{Rcpp}$ (using $\mathbf{C++}$ in $\mathbf{R}$) to improve computational scaling for petacomputing. Supervised junior statisticians and programmers.
