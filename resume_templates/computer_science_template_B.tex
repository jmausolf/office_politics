...
\begin{supertabular}{p{13.9cm}>{\raggedleft\arraybackslash}p{3.4cm}}
	...
	\begin{enumerate*}[label =$\circ$, itemjoin={\newline}]
		\item \footnotesize Developed a full-stack web application using JavaScript \emph{React}, \emph{D3} and \emph{CSS}, allowing users to explore interactive web features all the while increasing load times by 13\% for a more seamless user interface.
