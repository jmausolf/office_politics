...
\begin{supertabular}{p{13.9cm}>{\raggedleft\arraybackslash}p{3.4cm}}
    ...
    \item \footnotesize Performed AI training on an Amazon EC2 GPU instance.
    \item \footnotesize Created a virtual driving experience by developing an iOS app that wirelessly displays and operates RC cameras.
	\end{enumerate*} \vspace{2mm} & \\
