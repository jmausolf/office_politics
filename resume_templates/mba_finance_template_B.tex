...
\begin{supertabular}{p{17.3cm}}
	\small Results-oriented MBA candidate and business professional with over 5 years of experience spanning financial and business analysis. Proven track record in business analytics, with an MBA focus on \emph{finance} and competencies in corporate finance, investment management, and leadership.\\
  \multicolumn{1}{c}{} \\
\end{supertabular}
...
\begin{supertabular}{p{1.5cm}p{13.9cm}>{\raggedleft\arraybackslash}p{1.5cm}}
	...
	\item \footnotesize \emph{Finance} MBA with experience in corporate finance, leadership, investment management, and analytics.
