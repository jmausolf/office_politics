...
## Below is an edited version of the finalise_plot from bbplot()
## **chief upgrade is the option to remove the footer
## **which is preferred for embedding in academic papers versus websites
...
finalise_plot <- function(plot_name,
  ...
  #Create footer (if true) and plot grid
  if (isTRUE(footer)){
