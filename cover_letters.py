...
class cl(object):
	...
	def computer_science_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		...
		message = inspect.cleandoc("""Dear {0}:
			...
			I hope this email finds you well. I recently came across the {1} position at {3}'s {2} office. As a M.S. candidate in {6} at {5}, I research the application of nonparametric bound estimation for deep reinforcement learning, a type of computer vision. Given, {3}'s opportunities in machine learning and data science, I would love to contribute my talents.
