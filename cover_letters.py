...
class cl(object):
	...
	def computer_science_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		message = inspect.cleandoc("""Hi {0},
			...
			As a computer scientist, I have both the theoretical knowledge and applied experience to make a difference at {3}. If you peruse my resume, you'll notice that I have not only developed enhanced RNN algorithms in Java, but also used Python, Spark, and SQL to apply deep neural nets and streamline ETL pipelines as a software engineering intern for both {4}. Collectively, my background in computer science as well as statistical modeling gives me first-hand experience into the crux of today’s complex puzzles in software engineering their applications at the frontier of artificial intelligence.
	...
	def computer_science_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		...
		message = inspect.cleandoc("""Dear {0}:
			...
			With my background in computer science, I exhibit both the academic theory and pragmatic qualifications to be impactful at {3}. As evidenced in my resume, I have used my dissertation to develop a C++ library that optimizes deep learning. Moreover, I have applied my computational skills in Python, SQL, and Hadoop to improve ETL server efficiency and provide impactful analytics during my summer software engineering internships at {4}. Both within and outside the workplace, I embrace collaboration, such as my efforts at {4} to share actionable data solutions or my past initiatives as {7} to direct fundraisers and organize student activities.

			In combination, my collaborative skills and computational abilities in artificial intelligence and computer programming illustrate the value I can bring to {3}, and I am delighted to submit my application. To that end, I have attached my resume for review. I hope to hear from you shortly.
