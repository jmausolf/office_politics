...
class cl(object):
	...
	def data_science_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		message = inspect.cleandoc("""Hi {0},
			...
			I am writing in response to your notice for the {1} opening at your {2} office. I am a doctoral candidate in {6} at {5} specializing in the application of recurrent neural networks in cloud computing. {3} has excellent careers in data science and artificial intelligence, and I am confident, together, we would be a great match.
	...
	def stats_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		message = inspect.cleandoc("""Hi {0},
			...
			I am writing in response to your notice for the {1} opening at your {2} office. I am a doctoral candidate in {6} at {5} specializing in the application Bayesian nonparametric inference. {3} has excellent careers in statistical learning, and I am confident, together, we would be a great match.
	...
	def quant_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		message = inspect.cleandoc("""Hi {0},
			...
			I am writing in response to your notice for the {1} opening at your {2} office. I am a doctoral candidate in {6} at {5} specializing in the application of Bayesian nonparametric inference in statistical learning. {3} has excellent careers in statistics and mathematical finance, and I am confident, together, we would be a great match.
	...
	def computer_science_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		message = inspect.cleandoc("""Hi {0},
			...
			I am writing in response to your notice for the {1} opening at your {2} office. I am a masters candidate in {6} at {5} specializing in the application of recurrent neural networks in cloud computing. {3} has excellent careers in software development, and I am confident, together, we would be a great match.
			...
			Although I have a number of methodological strengths and my masters degree underscores my ability to tackle multifaceted problems, I also strive to work as a team player, whether it's by working with colleagues at {4} to communicate data-driven solutions or spearheading fundraising initiatives and leading a diverse set of students during my tenure as {7}. I think you will agree that my programming background—combined with my outgoing charisma and penchant for team leadership—makes me a valuable recruit for the position at {3}.
