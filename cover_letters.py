...
class cl(object):
	...
	def data_science_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		...
		message = inspect.cleandoc("""Dear {0}:
			...
			In combination, my collaborative skills and computational abilities in artificial intelligence, mathematics, and statistics illustrate the value I can bring to {3}, and I am delighted to proceed and continue the conversation. To that end, I have attached my resume for review. I hope to hear from you shortly.
	...
	def stats_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		...
		message = inspect.cleandoc("""Dear {0}:
			...
			In combination, my collaborative skills and computational abilities in statistics, computer science, and mathematics illustrate the value I can bring to {3}, and I am delighted to proceed and continue the conversation. To that end, I have attached my resume for review. I hope to hear from you shortly.
	...
	def quant_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		...
		message = inspect.cleandoc("""Dear {0}:
			...
			With my background in computational statistics, I exhibit both the academic theory and pragmatic qualifications to be impactful at {3}. As evidenced in my resume, I have used my dissertation to develop a C++ library that optimizes high-dimensional Bayesian learning and sparse signal processing. Moreover, I have applied my computational skills in C++, Python, SQL, and Hadoop to develop automated quantitative trading strategies, simulate portfolio returns, and drive impactful investment analytics during my summer quantitative research internships at {4}. Both within and outside the workplace, I embrace collaboration, such as my efforts at {4} to share actionable data intelligence or my past initiatives as {7} to direct fundraisers and organize student activities.

			In combination, my collaborative skills and computational abilities in statistics, computer science, and applied mathematics illustrate the value I can bring to {3}, and I am delighted to proceed and continue the conversation. To that end, I have attached my resume for review. I hope to hear from you shortly.
	...
	def computer_science_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		message = inspect.cleandoc("""Hi {0},
			...
			As a computer scientist, I have both the theoretical knowledge and applied experience to make a difference at {3}. If you peruse my resume, you'll notice that I have not only developed enhanced RNN algorithms in Java and used Python, Spark, and SQL to streamline data engineering, but I have also utilized CSS, JavaScript, and PHP in support of both frontend and backend development as a software engineering intern for {4}. In my spare time, I have applied my knowledge of cloud computing as well as Swift and Objective-C to develop an iOS application for video meme sharing. Collectively, my background in computer science gives me first-hand experience into the crux of today’s complex puzzles in software engineering their applications at the frontier of artificial intelligence and cloud computing.

			Although I have a number of methodological strengths and my masters degree underscores my ability to tackle multifaceted problems, independence has limits. Therefore, I also strive to work as a team player, whether it's by working with colleagues at {4} to communicate programming solutions or spearheading fundraising initiatives and leading a diverse set of students during my tenure as {7}. I think you will agree that my programming background—combined with my outgoing charisma and penchant for team leadership—makes me a valuable recruit for the position at {3}.
	...
	def computer_science_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		...
		message = inspect.cleandoc("""Dear {0}:
			...
			In combination, my collaborative skills and computational abilities in artificial intelligence and computer programming illustrate the value I can bring to {3}, and I am delighted to proceed and continue the conversation. To that end, I have attached my resume for review. I hope to hear from you shortly.
	...
	def mba_finance_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		message = inspect.cleandoc("""Hi {0},
			...
			Although I have a number of methodological strengths and my MBA underscores my ability to tackle multifaceted problems, independence has limits. Therefore, I also strive to work as a team player, whether it's by working with colleagues at {4} to communicate financial solutions or spearheading fundraising initiatives and leading a diverse set of students during my tenure as {6}. I think you will agree that my finance background—combined with my analytics capacity and outgoing penchant for team leadership—makes me a valuable recruit for the position at {3}.
	...
	def mba_finance_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment, internship1, internship2):
		...
		message = inspect.cleandoc("""Dear {0}:
			...
			With my business school background, I exhibit both the textbook financial insights and pragmatic qualifications to be impactful at {3}. As evidenced in my resume, I have applied my knowledge of finance and economics to modeling corporate investment portfolios, minimizing production costs, and offering financial planning that optimizes business revenue and spending. Moreover, I have been able to not only generate impactful business analytics but also demonstrate the capacity to use this knowledge to develop financial and business strategy during my experience at {4}. Both within and outside the workplace, I embrace collaboration, such as my efforts at {4} to leverage actionable data intelligence or my past initiatives as {6} to direct fundraisers and organize student activities.

			In combination, my collaborative skills, financial management abilities, and analytics capacity illustrate the value I can bring to {3}, and I am delighted to proceed and continue the conversation. To that end, I have attached my resume for review. I hope to hear from you shortly.
