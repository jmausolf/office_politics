...
class cl(object):
	...
	def stats_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		message = inspect.cleandoc("""Dear {0},
	...
	def stats_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		contact_full = "{} {}".format(contact, contact_last_name)
		message = inspect.cleandoc("""Dear {0}:
	...
	def quant_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		message = inspect.cleandoc("""Dear {0},
	...
	def quant_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		contact_full = "{} {}".format(contact, contact_last_name)
		message = inspect.cleandoc("""Dear {0}:
	...
	def computer_science_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		message = inspect.cleandoc("""Dear {0},

			I am writing in response to your notice for the {1} position at your {2} office. I am a masters candidate in {6} at {5}, specializing in the application of recurrent neural networks in cloud computing. {3} is a leader in software development, and I am confident, together, we would be a great match.

			As a computer scientist, I have both the theoretical knowledge and applied experience to make a difference at {3}. As you can see from my resume, I have not only developed enhanced RNN algorithms in Java, but also used Python, Scala, and SQL to apply deep neural nets and streamline ETL pipelines as a software engineering intern for both {4}. Collectively, my background in computer science, statistics, and mathematical modeling gives me first-hand experience into the crux of today’s complex puzzles in data science and their applications at the frontier of artificial intelligence.

			Although I have strong methodological strengths and my masters degree underscores my ability to tackle complex problems, I also strive to work as a team player, whether it's by working with colleagues at {4} to communicate data-driven solutions or spearheading fundraising initiatives and leading a diverse set of students during my tenure as {7}. I think you will agree that my programming background—combined with my outgoing charisma and penchant for team leadership—makes me a valuable recruit for the data scientist position at {3}.
	...
	def computer_science_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		contact_full = "{} {}".format(contact, contact_last_name)
		message = inspect.cleandoc("""Dear {0}:
	...
	def consultant_A(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		message = inspect.cleandoc("""Dear {0},
	...
	def consultant_B(self, contact, contact_last_name, job, office, company, internships, school, department, treatment):
		contact_full = "{} {}".format(contact, contact_last_name)
		message = inspect.cleandoc("""Dear {0}:
