...
\begin{supertabular}{p{2cm} p{1.0cm} p{13.9cm}}
	\textsc{2019}		&		\textsc{Ph.D.} & \textsc{GRADSCHOOL}, Computer Science \\
...
\begin{supertabular}{l p{0.55cm} p{13.9cm}}
	...
	\small\textsc{}							&& \small	\emph{Graduate Research Assistant}, Department of Computer Science \\
															&& \begin{enumerate*}[label =$\diamond$,itemjoin={\newline}]
...
\textsc{2014-2019} 					& \textsc{GRADSCHOOL} \\
	...
	\textsc{2009-2013} 				& \textsc{UGSCHOOL} \\
														& \begin{enumerate*}[label =$\diamond$, itemjoin={\newline}]
																...
																\item \footnotesize  Spreadheaded fundraisers and managed campus events as President of TREATMENT
																\end{enumerate*} \vspace{2mm} \\
